...
function() {
        ...
        qq.basePublicApi = {
            ...
            _handleNewFile: function(a, b) {
                var c, d = -1,
                    e = qq.getUniqueId(),
                    f = qq.getFilename(a);
                a.size >= 0 ? d = a.size : a.blob && (d = a.blob.size), c = this._uploadData.addFile(e, f, d), this._handler.add(c, a), this._netUploadedOrQueued++, b.push({
                    id: c,
                    file: a
                })
            },
    ...
    function() {
        ...
        qq.extend(a, {
                ...
                l ? e(a, b) : j[a.id] = qq(a).attach("load", function() {
                    if (s("Received response for " + a.id), a.parentNode) {
                        try {
                            ...
                            s("Error when attempting to access iframe during handling of upload response (" + d.message + ")", "error"), c = {
                                success: !1
                            }
                        }
                        b(c)
            ...
            add: function(a, b) {
                m[a] = {
                    input: b
                }, b.setAttribute("name", n), b.parentNode && qq(b).remove()
            },
            getInput: function(a) {
                return m[a].input
            },
    ...
    function() {
        ...
        var y, z, A, B, C, D, E, F, G = "qq-file-id",
            H = "qq-file-id-",
            I = "qq-max-size",
            J = "qq-server-scale",
            K = "qq-hide-dropzone",
        ...
        function c(a, b) {
            ...
            try {
                ...
                k("Error when attempting to parse form upload response (" + f.message + ")", "error"), c = {
                    success: !1
                }
            }
            return c
        ...
        function d(b, c) {
            var d = a.paramsStore.getParams(b),
                ...
                g = h(b);
            return d[a.uuidName] = i(b), d[a.filenameParam] = g, l.initFormForUpload({
                method: e,
                endpoint: f,
                params: d,
        ...
        function i(b) {
            var c, h, i = K[b].remainingChunkIdxs[0],
                k = P.getChunkData(b, i),
                l = P.createXhr(b),
                m = I(b),
                n = G(b);
        ...
        function v(a) {
            var b, c, d, e, f, g, h = qq.getCookie(w(a)),
                i = G(a);
            if (h) {
                if (b = h.split(L), 5 === b.length) return c = b[0], d = parseInt(b[1], 10), e = parseInt(b[2], 10), f = parseInt(b[3], 10), g = parseInt(b[4], 10), {
                    uuid: c,
                    part: d,
                    lastByteSent: e,
        ...
        function B(b) {
            var c, d, e, h = K[b].file || K[b].blobData.blob,
                i = G(b);
        ...
        var D, E = b.onUploadComplete,
            ...
            K = [],
            L = "|",
            M = a.chunking.enabled && qq.supportedFeatures.chunking,
            N = a.resume.enabled && M && qq.supportedFeatures.resume,
            O = a.forceMultipart || a.paramsInBody,
            P = {},
            Q = this;
        D = c(), qq.extend(this, new qq.UploadHandlerXhrApi(P, {
            fileState: K,
