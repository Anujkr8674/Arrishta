! function(e, t) {
    ...
    function n(s) {
        if (s < t.breakPointWidth) {
            ...
            e(".master-wrapper-main").append('<div class="mobile-banners"></div>'), e(".mobile-banners").append(n)
        } else e(".mobile-banners").detach()
    }

    function i(s) {
        e(".block").each(function() {
            sevenSpikes.getViewPort().width > t.breakPointWidth ? s || (!1 === k.isEnabled ? (e(this).children().eq(1).show(), e(this).children().eq(0).children("a.toggleControl").removeClass("closed")) : e(this).children(".listbox").eq(0).show(), e(this).find(".jcarousel-container-vertical").show()) : (!1 === k.isEnabled ? (e(this).children().eq(1).hide(), e(this).children().eq(0).children("a.toggleControl").addClass("closed")) : e(this).children(".listbox").eq(0).hide(), e(this).find(".jcarousel-container-vertical").hide())
        })
    }
    ...
    function l(t, s) {
        ...
        if (0 !== i.length && 0 !== s.length) {
            ...
            o <= e(s).offset().top ? n.removeClass("nav-up") : (o > w ? i.addClass("nav-up") : i.removeClass("nav-up"), w = o)
        } else n.removeClass("nav-up")
    }

    function c(t, s) {
        var n = e(s),
            i = e(window).scrollTop();
        i > 0 && i >= n.offset().top ? (n.css("height", n.height() + "px"), e(t).addClass("stick"), e(document).trigger({
            type: "navigationHasSticked"
        })) : (n.css("height", ""), e(t).removeClass("stick"), e(document).trigger({
            type: "navigationHasSticked"
        }))
    }
    ...
    function p(s, n) {
        ...
        s <= t.breakPointWidth ? (e(i.headerMenu).add(e(i.sublist)).add(e(i.overlayOffCanvas)), e(i.filtersContainer).detach().insertAfter(i.headerMenu), o && e(i.searchBox).detach().insertAfter(i.navWrapperParent), r && e(i.headerLinksWrapper).detach().insertAfter(i.headerLinksWrapperMobileInsertAfter), e(i.shoppingCartLink).off("mouseenter.flyout-cart").off("mouseleave.flyout-cart"), e(".top-menu > li > .sublist-wrap").css("display", "")) : (e(i.headerMenu).css({
            ...
            height: "",
            top: ""
        }), e(i.filtersContainer).css("height", ""), n || e(i.filtersContainer).detach().insertBefore("#availableSortOptionsJson"), r && e(i.headerLinksWrapper).detach().prependTo(i.headerLinksWrapperDesktopPrependTo), o && e(i.searchBox).detach().insertAfter(i.searchBoxBefore), e(i.shoppingCartLink).on("mouseenter.flyout-cart", function(t) {
    ...
    function f() {
        var t = k.selectors;
        e(t.headerMenu).addClass("open"), e(t.movedElements).addClass("move-right"), h(t)
    }
    ...
    function v() {
        ...
        e(t.searchBoxOpener).click(function() {
            ...
            e(t.sublist).parent().removeClass("active").animate({
                scrollTop: 0
            }), e(t.headerMenu).add(e(t.filtersContainer)).removeClass("open"), e(t.searchBox).removeClass("open"), e(t.headerLinksWrapper).removeClass("open"), u(), k.isEnabled && e(".header-menu, .sublist-wrap, .nopAjaxFilters7Spikes.open").perfectScrollbar("destroy")
        }), e(".sublist").on("click", ".back-button", function() {
            e(this).closest(".sublist-wrap").removeClass("active"), k.isEnabled && e(this).parents().eq(4).perfectScrollbar({
                swipePropagation: !1,
                wheelSpeed: 2,
                suppressScrollX: !0
            })
        ...
        }), e('<div class="close-filters"><span>close</span></div>').insertBefore(".filtersPanel"), e(".close-filters").click(function() {
    ...
    ! function(s) {
        "function" != typeof String.prototype.trim && (String.prototype.trim = function() {
            ...
            if (!(null == document.body || s > 10)) {
                ...
                o.setAttribute("class", "javascriptErrorsElement"), o.setAttribute("type", "hidden"), o.setAttribute("value", i), document.body.appendChild(o), s++
            }
        }, window.onload = function() {
            sevenSpikes.getViewPort().width <= t.breakPointWidth && e(".block .jcarousel-container-vertical").hide(), e(".mega-menu-responsive .labelfornextplusbutton").on("click", function() {
        ...
        simpleSelect: function() {
            return this.each(function() {
                var t = e(this);
                t.parent().hasClass("select-wrap") || (t.wrap('<div class="select-wrap"></div>').after('<span class="select-box"><span class="select-inner">' + t.find(":selected").text() + "</span></span>"), t.change(function() {
        ...
        for (var t, s = [], n = window.location.href.slice(window.location.href.indexOf("?") + 1).split("&"), i = 0; i < n.length; i++)
            if (t = n[i].split("="), s.push(t[0]), s[t[0]] = t[1], null != e && t[0] === e) return t[1];
        ...
        s = s || t.getViewPort().width, !1 === g && (e(".menu-title").click(function() {
            e(this).hasClass("close") ? e(this).removeClass("close") : e(this).addClass("close"), e(this).siblings(".top-menu, .mega-menu-responsive").slideToggle("fast", function() {
                e(this).css("overflow", "")
            ...
            n.hasClass("active") ? n.removeClass("active") : k.isEnabled ? s.parents().eq(2).animate({
                ...
                n.addClass("active")
            }) : n.addClass("active"), k.isEnabled && s.parents().eq(2).perfectScrollbar("destroy")
        }), g = !0);
        s > t.breakPointWidth ? (e(".sublist-wrap.active").removeClass("active"), e(".plus-button.close").removeClass("close"), e(".top-menu li").each(function() {
            var t, s;
            e(this).on("mouseenter", function() {
                var n = e(this);
                clearTimeout(s), t = setTimeout(function() {
                    e("a", n).first().addClass("hover"), e(".sublist-wrap", n).first().addClass("active")
                }, 180)
            }).on("mouseleave", function() {
                var n = e(this);
                clearTimeout(t), s = setTimeout(function() {
                    e("a", n).first().removeClass("hover"), e(".sublist-wrap", n).first().removeClass("active")
                }, 180)
            })
        })) : (e(".top-menu li").off("mouseenter mouseleave"), e(".sublist-wrap.active").removeClass("active"), e(".plus-button.close").removeClass("close"))
    }, t.initResponsiveTheme = function(r) {
        if (null != r) {
            null != (k = r).selectors && (null == k.selectors.headerLinksWrapperMobileInsertAfter && (k.selectors.headerLinksWrapperMobileInsertAfter = ".header"), null == k.selectors.headerLinksWrapperDesktopPrependTo && (k.selectors.headerLinksWrapperDesktopPrependTo = ".header")), t.breakPointWidth = k.themeBreakpoint || 980;
            var l = sevenSpikes.getViewPort().width,
                c = function(o) {
                    var r = sevenSpikes.getViewPort().width;
                    k.isEnabled && o && k.doesDesktopHeaderMenuStick && e(k.selectors.headerMenu).wrap('<div id="headerMenuParent" class="header-menu-parent"></div>'), (o || r > t.breakPointWidth && l <= t.breakPointWidth || r <= t.breakPointWidth && l > t.breakPointWidth) && (t.prepareTopMenu(r), s(k.shouldAddClassForMobile), i(o), k.hasSideBanners && n(r), k.isEnabled && (p(r, o), !0 === k.doesSublistHasIndent && a()), e(document).trigger({
                        type: "themeBreakpointPassed7Spikes",
                        isInitialLoad: o,
                        isMobileResolution: r <= t.breakPointWidth
                    })), l = r
                };
            if (c(!0), sevenSpikes.addWindowEvent("resize", function() {
                    c(!1)
                }), sevenSpikes.addWindowEvent("orientationchange", function() {
                    c(!1)
                }), k.isEnabled) {
                (k.hasStickyNav || k.displayGoToTop || k.doesDesktopHeaderMenuStick) && (null == k.selectors.headerMenuDesktopStickElement && (k.selectors.headerMenuDesktopStickElement = k.selectors.headerMenu), null == k.selectors.headerMenuDesktopStickParentElement && (k.selectors.headerMenuDesktopStickParentElement = "#headerMenuParent"), d()), v();
                ...
                !0 === k.doesScrollAfterFiltration && e(document).on("nopAjaxFiltersFiltrationCompleteEvent", function() {
                    sevenSpikes.getViewPort().width <= t.breakPointWidth && u && (e(k.selectors.overlayOffCanvas).triggerHandler("click"), setTimeout(function() {
