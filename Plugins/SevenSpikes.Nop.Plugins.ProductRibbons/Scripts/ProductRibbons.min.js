...
! function(t, r, o) {
    function e() {
        ...
        if (n && n > 0 && e) {
            var u = r(e).find(t);
            u && 0 !== u.length || (d.productId = n, d.productElement = r(e))
        }
    ...
    function a(t, e, a) {
        ...
        if (e.productElement) {
            if (a) {
                if (d = o.getAttrValFromDom(i, "data-productPageBugPictureContainerSelector"), !d) return
            } else if (d = o.getAttrValFromDom(i, "data-productBoxPictureContainerSelector"), !d) return;
            var n = e.productElement.find(d);
            if (n.parent().hasClass(u)) return;
            if (n && e.productId && e.productId > 0) {
                var c, p = e.productId;
                c = a ? r(t).filter("div[data-productId='" + p + "']") : r(t).filter("a[data-productId='" + p + "']"), c && c.length > 0 && (n.wrap('<div class="' + u + '"></div>'), n.after(c))
            }
        }
    }
    ...
    t.showRibbons = function() {
        ...
        if (t || 0 !== o.length) {
            ...
            r.ajax({
                ...
                t && (d(t, a), r.event.trigger({
                    type: "nopProductRibbonsLoadingCompleteEvent"
                }))
            })
        }
    }, r(document).ready(function() {
        c = o.getAttrValFromDom(i, "data-productBoxSelector"), c && t.showRibbons()
