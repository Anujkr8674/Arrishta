        ...
        if (i.one("mouseover", function() {
            ...
            i.children("li").add(i.find(".sublist").children("li")).off("mouseenter mouseleave").on("mouseenter", function() {
                ...
                t = setTimeout(function() {
                    e("a", i).first().addClass("hover"), e(".sublist-wrap, .dropdown", i).first().addClass("active")
                }, 180)
            }).on("mouseleave", function() {
                var i = e(this);
                clearTimeout(t), e("a", i).first().removeClass("hover"), e(".sublist-wrap, .dropdown", i).first().removeClass("active")
            })
        }
    }
