    ...
    return function(e) {
        ...
        function n(e) {
            ...
            if (e.api) r.push({
                ...
                for (n = o ? o.changedTouches : [], t = n.length; t > u; u++) i = n[u], r.push({
                    location: i,
                    event: e,
                    target: i.target,
                    currentTarget: s,
        ...
        var o = window.kendo,
            ...
            z = u.extend({
                ...
                move: function(e) {
                    ...
                    var t = this;
                    t.endTime = c(), t._finished || (t._finished = !0, t._moved ? t._trigger(w, e) : t._trigger(F, e), clearTimeout(t._holdTimeout), t._trigger(k, e), t.dispose())
                },
                dispose: function() {
            ...
            E = l.extend({
                init: function(t, n) {
                    var i, u, c, f = this,
                        h = o.guid();
                    n = n || {}, i = f.filter = n.filter, f.threshold = n.threshold || g, f.minHold = n.minHold || p, f.touches = [], f._maxTouches = n.multiTouch ? 2 : 1, f.allowSelection = n.allowSelection, f.captureUpIfMoved = n.captureUpIfMoved, f.eventNS = h, t = e(t).handler(f), l.fn.init.call(f), d(f, {
                        element: t,
                        surface: n.global ? e(s.documentElement) : e(n.surface || t),
                        stopPropagation: n.stopPropagation,
                        pressed: !1
                    }), f.surface.handler(f).on(o.applyEventMap("move", h), "_move").on(o.applyEventMap("up cancel", h), "_end"), t.on(o.applyEventMap("down", h), i, "_start"), (a.pointers || a.msPointers) && t.css("-ms-touch-action", "pinch-zoom double-tap-zoom"), n.preventDragEvent && t.on(o.applyEventMap("dragstart", h), o.preventDefault), t.on(o.applyEventMap("mousedown selectstart", h), i, {
                        root: t
                    }, "_select"), f.captureUpIfMoved && a.eventCapture && (u = f.surface[0], c = e.proxy(f.preventIfMoving, f), r(function(e) {
                ...
                _start: function(t) {
                    ...
                    if (!(c && c > 1 || o._maxTouchesReached()))
                        for (E.current = null, o.currentTarget = t.currentTarget, o.stopPropagation && t.stopPropagation(); l > a && !o._maxTouchesReached(); a++) r = u[a], i = s ? e(r.currentTarget) : o.element, i.length && (r = new z(o, i, r), o.touches.push(r), r.press(), o._isMultiTouch() && o.notify("gesturestart", {}))
                },
                _move: function(e) {
        ...
        E.minHold = function(e) {
            p = e
        }, o.getTouches = n, o.touchDelta = t, o.UserEvents = E
